...
<body>
    ...
    <div class="loginbox">
       ...
       <form class="form" action="Validaciones.php" method="POST">
           <label for="name">Nombres: </label>
           <input type="text"  placeholder="Ingrese Nombres" name="Nombres" required maxlenght> 
           ...
           <input type="text" placeholder="Ingrese Numero" name="Documento" required required maxlenght="11"> 
           <label for="phone">Telefono: </label>        
           <input type="text" placeholder="Ingrese documento" name="Telefono" required required maxlenght="11"> 
           ...
           <input type="text" placeholder="Ingrese correo" name="NombreUsu" required> 
