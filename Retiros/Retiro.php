...
<body>
    ...
    <div class="loginbox">
       ...
       <form class="form" action="Validacion1.php" method="POST">  
        ...
        <input type="text" placeholder="Ingrese Numero" name="Documento">
           ...
           <label for="docum">Valor a retirar: </label>        
           ...
           <br> 
           <input class="btn btn-efecto" type="submit" name="Retirar" value="Retirar">
