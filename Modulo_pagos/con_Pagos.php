    ...
    <body>
        ...
        <div class="loginbox">
           ...
           <form >
                ...
                <input class="form-control me-auto" type="text" placeholder="Codigo a consultar" aria-label="Consultar Pago">
                <button type="button" class="btn btn-secondary">Consultar</button>
                <div class="vr"></div>
                <button type="button2" class="btn btn-outline-danger">Cancelar</button>          
